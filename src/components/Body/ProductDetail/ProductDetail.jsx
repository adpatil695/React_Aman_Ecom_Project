...
//  console.log('click no.',Number(prodDetailID))
//  console.log('Detail page', filterDataProdDetail)
          ...
          <div className="prod-detail" key={item.id}>
            <div>
              <img
                ...
                className="prod-img-detail"
                alt="No img"
              />
              <div>
                <button
                  className="prod-btn-detail"
